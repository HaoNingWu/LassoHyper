...
function [err_I,errest_I,err2_I,LV,LCalfa,Ltime,Calfa,f_name,L,Finterp]=CX_Interpolation(n,f_idx,lambda,sigma)
% -----------------------------------------------------------------
%  Non-tensor product points on the cube
% -----------------------------------------------------------------
%  M-function that allows to compute the 
%  interpolant
%
% input: n=degree
% outputs: err_I=rel abs hyperinterpolation error
%          errest_I=estimate hyperinterpolatio error
%          LV=function evaluations
%          LCalfa=the number of hyperinterpolation coefficients Calfa
%          Ltime=cputime
%          fname=function name
%------------------------------------------------------------------
%  Authors: 
...
% Version: May 2008
% -------------------------------------------------------------------
% Modified by H.-N. Wu 2021, in consideration of noisy data
